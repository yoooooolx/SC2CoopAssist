...
class MapRtK {
    ...
    inner class CountdownTask(private val remainTime:TextView, private val timer:Timer):TimerTask(){  // 更新倒计时的TimerTask
        override fun run() {
            ...
            if (timeRemain<0){  // 最后一波红点刷新了，停止计时
                ...
                // 修改UI
                val changeText= Runnable { remainTime.text = String.format("%2d : %02d",timeMin,timeSec) }
